...
fn test_deposit_flow() {
    ...
    assert_eq!(deposit_res.transaction, Nat::from(0));
    ...
    assert_eq!(deposit_res.transaction, Nat::from(1));
...
fn test_send_flow() {
    ...
    assert_eq!(deposit_res.transaction, 0);
...
fn test_create_canister() {
    ...
    if let CreateCanisterError::FailedToCreate {
        fee_transaction: fee_block,
        refund_transaction: refund_block,
        error: _,
    } = create_canister(
        &env,
        ledger_id,
